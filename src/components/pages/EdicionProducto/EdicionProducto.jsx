...
const EdicionProducto = (props) => {
  ...
  //   name: Yup.string().min(0, "Too Short!").max(50, "Too Long!").required(),
  // });
                ...
                <Form className="my-2" onSubmit={handleSubmit} >
                  <Form.Group className="my-1" controlId="nombrerProducto">
                    ...
                    <Form.Control
                      ...
                      maxLength={50}
                      minLength={1}
                      defaultValue={productoEditar.ProductName}
                      ref={productoNameRef}
                    />
                  </Form.Group>
                  <Form.Group className="my-1" controlId="detalleProducto">
                    ...
                    <Form.Control
                      ...
                      maxLength={100}
                      minLength={10}
                      defaultValue={productoEditar.Productdetalle}
                      ref={productoEditarRef}
                    />
                  </Form.Group>
                  <Form.Group className="my-1" controlId="precioProducto">
                    ...
                    <Form.Control
                      type="number"
                      placeholder="Ej: 250"
                      defaultValue={productoEditar.PriceProduct}
                      ref={productoPriceRef}
                    />
                  </Form.Group>
                  ...
                  <Form.Group className="my-1" controlId="Graduacion">
                    ...
                    <Form.Control
                      type="text"
                      placeholder="Ej: 5%"
                      defaultValue={productoEditar.Graduation}
                  ...
                  <Form.Group className="my-1" controlId="Disponibiliadad">
                    ...
                    <Form.Select
                      value={productoEditar.Avaliable}
                      onChange={({ target }) =>
                        setProductoEditar({
                          ...productoEditar,
                          Avaliable: target.value,
                        })
                      }
                    >
                  ...
                  <div className="text-center mt-3">
                    <Button variant="warning" onClick={handleSubmit2  }>
                      Update 🍻
                    </Button>
                    <Button
                      variant="danger"
